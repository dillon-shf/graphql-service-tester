    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (program.verbose) {
            ...
            terminal_kit_1.terminal.table(reportData.map((report) => [
                ...
                `${report.status === 'passed' && report.run.meetsSLA ? '' : '^R'}${report.query.signature || report.query.query} ${report.errors.length ? '\n\n' + report.errors[0] + '\n' : ''}\n`,
        ...
        failedTests.forEach((report) => {
            report.errors.forEach((err) => {
                terminal_kit_1.terminal.red(`${report.query.signature || report.query.query} \n`);
